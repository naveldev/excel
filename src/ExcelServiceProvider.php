...
use Navel\Excel\Cache\CacheManager;
use Navel\Excel\Console\ExportMakeCommand;
use Navel\Excel\Console\ImportMakeCommand;
use Navel\Excel\Files\Filesystem;
use Navel\Excel\Files\TemporaryFileFactory;
use Navel\Excel\Mixins\DownloadCollection;
use Navel\Excel\Mixins\StoreCollection;
use Navel\Excel\Transactions\TransactionHandler;
use Navel\Excel\Transactions\TransactionManager;
...
class ExcelServiceProvider extends ServiceProvider
{
    ...
    {
        return dirname( __DIR__ ) . DIRECTORY_SEPARATOR . 'config' . DIRECTORY_SEPARATOR . 'excel.php';
    }
}
